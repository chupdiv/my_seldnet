                ...
                for i, active_event in enumerate(active_event_list):
                    ...
                    if i == len(active_event_list) - 1:  # if the last
                        if len(active_event_list_per_class) == 1:  # if no ov from the same class
                            ...
                            dist_label[frame_ind, 0, active_event_a0[0]] = active_event_a0[5]
                            ...
                            dist_label[frame_ind, 1, active_event_b0[0]] = active_event_b0[5]
                            # --b1--
                            ...
                            dist_label[frame_ind, 2, active_event_b1[0]] = active_event_b1[5]
                            ...
                            dist_label[frame_ind, 3, active_event_c0[0]] = active_event_c0[5]
                            # ----c1
                            ...
                            dist_label[frame_ind, 4, active_event_c1[0]] = active_event_c1[5]
                            # ----c2
                            ...
                            dist_label[frame_ind, 5, active_event_c2[0]] = active_event_c2[5]
